      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12">
        ...
        <div 
          ...
          <ul className="text-lg  space-y-4">
            <li><strong>Front-End:</strong> HTML5, CSS3, JavaScript (ES6), React.js, Next.js, Tailwind CSS, Bootstrap, TanStack Query, Axios , Daisy UI, Mamba UI</li>
            <li><strong>Authentication:</strong> Firebase , JSON Web Token (JWT) and Supabase</li>
            <li><strong>Back-End:</strong> Node.js, Express.js</li>
            <li><strong>Databases:</strong> MongoDB</li>
            <li><strong>APIs:</strong> REST APIs , Context APIs</li>
